...
from config.preprocessing_config import COLUMNS, RENAMED_COLUMNS
...
class DataProcessor:
    ...
    def preprocess_amenities_column(self) -> None:
        ...
        """
        amenities = ['TV', 'Internet', 'Air conditioning', 'Kitchen', 'Heating', 'Wifi', 'Elevator', 'Breakfast']
